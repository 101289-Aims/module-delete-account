...
class Confirm extends Action
{
    ...
    public function execute()
    {
        try {
            ...
            $customFeedbackId = $this->getRequest()->getParam('feedback_id', false);

            //Get data from feedback factory

            $feedback = $this->_feedback->create();
            $customFeedback = $feedback->load($customFeedbackId);
            ...
            if ($token === $customerToken) {
                ...
                $model->addData([
                    ...
                    "feedback" => $customFeedback->getData('feedback')
                ]);
                $model->save();
